...
public class programa {
	...
	public static void main(String[] args) {
		...
		// Caso "resposta = S": Inicia compras
	     if(resposta == 's' || resposta =='S' ) {
	     	// Imprime titulo para tabela de produtos     	System.out.print("\n◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾◻◾\n");
	     	System.out.print("\nRelação de Produtos\n\n");
	...
	//Ilanna
		...
		for(int x=0;x<10;x++) {
			System.out.printf("| ",codigo[x],"\t", produtos[x],"\t\t","R$ ",valor[x],"\t\t", estoque[x],"             |\n");
		}
		System.out.printf("\n________________________________________________________\n");
		...
		do{
			...
			contador++;
      		...
      		while(codProduto != "G4-1" && codProduto != "G4-2" && codProduto != "G4-3" && codProduto != "G4-4" && codProduto != "G4-5" && codProduto != "G4-6" && codProduto != "G4-8" && codProduto != "G4-9" && codProduto != "G4-10"){
      		System.out.print("\nCódigo Inválido, verifique e digite novamente:  ");
      		codProduto = leia.nextLine().toUpperCase();
      		}
      		
			for(int x=0;x<10; x++){
				if(codProduto == codigo[x]){
					linha = x;
	...
	//Karen
					do{
						...
						System.out.print("\n\t\t\t\t   LAIKA FAST\n");
						System.out.print("\n________________________________________________________________________________\n");
						System.out.printf("\n|Valor total da compra: R$ ",valorCompra,", 9% de imposto sob o valor corresponde a R$",Math.round(valorCompra * 0.09),2,"|");
						System.out.print("\n________________________________________________________________________________\n");
						System.out.print("\n\n▶ Qual seu nome? ");
						nome = leia.nextLine();
						...
						case 1:
							...
							for (int h=0;h<contador; h++){         		
								System.out.printf("\t\t\t",codigo[carrinho[h]],"\t", produtos[carrinho[h]],"\t\t","R$ ",valor[carrinho[h]], "\t\t"," x ", carrinhoQuantidade[h], "\n");
						}
							
							System.out.print("\n______________________________________________________________________________________________________________\n");
							System.out.printf("\t                   Valor total da compra a vista com 10% de desconto:  R$ ",Math.round(valorCompra * 0.9), 2);
							System.out.print("\n______________________________________________________________________________________________________________\n");
							...
							case 2:
								...
								b = 1;
									...
									System.out.print("______________________________________________________________________________________________________________\n");
									System.out.printf("\t                   Valor total da compra no credito com 10% de acrescimo R$",Math.round(valorCompra * 1.1),2);
									System.out.print("\n______________________________________________________________________________________________________________\n");
									System.out.print("\n\t                        AGRADECEMOS PELA PREFERÊNCIA! VOLTE SEMPRE!                                            \n");
									System.out.print("\n______________________________________________________________________________________________________________\n");
									break;
	...
	//Juan
							case 3:
								...
								System.out.print("______________________________________________________________________________________________________________\n");
									...
									for (int h=0;h<contador; h++){         		
										System.out.print("\t\t\t"+codigo[carrinho[h]]+"\t"+ produtos[carrinho[h]]+"\t\t"+"R$ "+valor[carrinho[h]]+ "\t\t"+" x "+ carrinhoQuantidade[h]+ "\n");
									}
								System.out.print("______________________________________________________________________________________________________________\n");
								System.out.printf("\t                   Valor total da compra parcelado com 15% de acrescimo "+Math.round(valorCompra * 1.15), 2+" com as duas parcelas no valor de: R$ ",valorCompra * 0.575);
								System.out.print("\n______________________________________________________________________________________________________________\n");
								System.out.print("\n\t                        AGRADECEMOS PELA PREFERÊNCIA! VOLTE SEMPRE!                                            \n");
								System.out.print("\n______________________________________________________________________________________________________________\n");
									break;
