				...
				do {
					...
					case 1:
						...
						System.out.print(
								"\n______________________________________________________________________________________________________________\n");
						System.out.print(
								"\t                   Valor total da compra a vista com 10% de desconto:  R$ "+
								Math.round((valorCompra * 0.9), 2));
						System.out.print(
								"\n______________________________________________________________________________________________________________\n");
						System.out.print(
					...
					case 2:
						...
						System.out.print(
								"______________________________________________________________________________________________________________\n");
						System.out.printf(
								"\t                   Valor total da compra no credito com 10% de acrescimo R$",
								Math.round(valorCompra * 1.1), 2);
						System.out.print(
								"\n______________________________________________________________________________________________________________\n");
						System.out.print(
								"\n\t                        AGRADECEMOS PELA PREFERÊNCIA! VOLTE SEMPRE!                                            \n");
...
//Juan
					case 3:
						...
						System.out.print(
								"______________________________________________________________________________________________________________\n");
						System.out.printf(
								"\t                   Valor total da compra parcelado com 15% de acrescimo "
										+ Math.round(valorCompra * 1.15),
								2 + " com as duas parcelas no valor de: R$ ", valorCompra * 0.575);
						System.out.print(
								"\n______________________________________________________________________________________________________________\n");
						System.out.print(
								"\n\t                        AGRADECEMOS PELA PREFERÊNCIA! VOLTE SEMPRE!                                            \n");
